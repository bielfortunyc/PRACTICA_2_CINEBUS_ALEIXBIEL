    ...
    for i in range(len(data['ObtenirDadesAMBResult']['Linies']['Linia'])):
        ...
        for parada in parades:
            if parada['Municipi'] == 'Barcelona':
                ...
                graph.add_node(node_id, pos=(node_x,node_y))
...
# Crear un objecte StaticMap amb el mapa de fons de la ciutat
    city_map = staticmap.StaticMap(800, 800)
    city_map.add_image_layer(staticmap.ImageLayer(nom_fitxer))
    ...
    for edge in g.edges:
        ...
        line = staticmap.Line(((x1,y1),(x2,y2)), "blue",5)
